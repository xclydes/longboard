...
public class UpworkRestClient {
    ...
    private static HttpRequestInitializer customInitializer;

    public static void setCustomInitializer(final HttpRequestInitializer customInitializer) {
        UpworkRestClient.customInitializer = customInitializer;
    }
    ...
    public static JSONObject executeRequest(HttpRequest request) throws JSONException {
        ...
        try {
            // Customize the request further
            if (customInitializer != null) {
                customInitializer.initialize(request);
            }
